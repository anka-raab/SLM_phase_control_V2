# -*- coding: utf-8 -*-
"""
Created on Thu Apr  6 18:08:50 2023
...
class mcp(object):
    ...
    def __init__(self,parent):
        ...
        self.win.protocol("WM_DELETE_WINDOW", self.on_close) #TODO: add a on_close thing
        self.rect_id = 0
        self.ready = 0
        ...
        self.ent_avg = tk.Entry(frm_cam_but, width=11,validate='all',validatecommand=(vcmd, '%d', '%P', '%S'),textvariable=self.strvar_avg)  
